...
const uncommonFish = [
    ...
    {fish: "Oxygen Cell (25%)", price: 520, lW: 10, hW: 15, rod: 0 },
...
const rareFish = [
    ...
    {fish: "Oxygen Cell (50%)", price: 520, lW: 10, hW: 15, rod: 0 },
...
const epicFish = [
    ...
    {fish: "Madelyn-Clinefish", price: 165, lW: 1, hW: 2, rod: 0 },
    {fish: "Elder Guardian", price: 140, lW: 75, hW: 125, rod: 1 },
    {fish: "Makifish", price: 125, lW: 155, hW: 155, rod: 1 },
    {fish: "Oxygen Cell (75%)", price: 520, lW: 10, hW: 15, rod: 0 },
...
module.exports = {
    ...
    try {
        ...
        if(interaction.channelId != 1227366385332654091){ //fish = 1227273573727604848 //lake-azure-haven = 1227330742523269142
            await interaction.editReply(`erm... what are u doing :nerd:`);
            return;
        }

        const commandName = "testfish";
        ...
        if(rodType >= 0){  //basic rod
            ...
            cooldown.endsAt = Date.now() + 7_200_000;
        ...
        // await Promise.all([cooldown.save(), userProfile.save(), fishFound.save(), fishingRods.save(), userArtifacts.save(), jackpotFish.save(), userHazmatInfo.save()]);

    } catch (error) {
        console.log(`Error handling /testfish: ${error}`);
    }
},
